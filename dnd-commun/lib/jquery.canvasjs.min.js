...
Math.floor(s);for(0>s&&(s+=v);s<v;s++)if(s in this&&this[s]===g)return s;return-1}function s(g){return null===g||"undefined"===typeof g}function Ca(g){g.indexOf||(g.indexOf=db);return g}function eb(g){if(S.fSDec)g[W("`eeDwdouMhrudods")]("Tapouweb",function(){S._fTWm&&S._fTWm(g)})}function Wa(g,m,v){v=v||"normal";var s=g+"_"+m+"_"+v,w=Xa[s];if(isNaN(w)){try{g="position:absolute; left:0px; top:-20000px; padding:0px;margin:0px;border:none;white-space:pre;line-height:normal;font-family:"+
